...
Route::middleware(['auth', 'checkrole:admin'])->group(function (){
    ...
    Route::delete('/guru/delete/{nip}', [GuruController::class, 'destroy'])->name('guru/delete');
    ...
    Route::delete('/siswa/delete/{nis}', [SiswaController::class, 'destroy'])->name('siswa/delete');
    ...
    Route::delete('/mapel/delete/{id}', [MapelController::class, 'destroy'])->name('mapel/delete');
...
Route::middleware(['auth', 'checkrole:admin,guru'])->group(function (){
    ...
    Route::get('/absensi/siswa/tanggal/{nis}', [AbsensiController::class, 'absensi'])->name('absensi/siswa/tanggal');
    ...
    Route::get('/jadwal/semester1/{id}', [JadwalController::class, 'showSemester1'])->name('jadwal/semester1');
    Route::get('/jadwal/semester2/{id}', [JadwalController::class, 'showSemester2'])->name('jadwal/semester2');
    ...
    Route::get('/nilai/siswa/mapel/semester2/{nis}', [NilaiController::class, 'nilaiSemester2'])->name('nilai/siswa/mapel/semester2');
    ...
    Route::delete('/nilai/delete/{id}', [NilaiController::class, 'destroy'])->name('nilai/delete');
});
...
Route::middleware(['auth', 'checkrole:admin,kepsek,guru'])->group(function (){
