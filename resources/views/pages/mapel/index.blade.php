                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                ...
                                <a href="/mapel/add" class="btn btn-primary">Tambah Data</a>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('mapel/edit', $item->id) }}" class="btn btn-icon btn-sm btn-warning">
                                                <i class="far fa-edit"></i>
                                            </a>
                                            <a href="{{ route('mapel/delete', $item->id) }}" class="btn btn-icon btn-sm btn-danger">
