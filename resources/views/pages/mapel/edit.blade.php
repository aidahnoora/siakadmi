                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('mapel/update', $mapels->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_mapel" class="form-control" value="{{ $mapels->nama_mapel }} " autofocus required>
                                </div>
                                <div class="form-group">
                                    <label for="tahun_mapel">Tahun</label>
                                    <input type="text" name="tahun_mapel" class="form-control" value="{{ $mapels->tahun_mapel }}" autofocus required>
                                </div>
                                <div class="form-group">
                                    <label for="semester">Semester</label>
                                    <select name="semester" class="form-control">
                                        <option value="1" {{ $mapels->semester == '1'? 'selected': ''}}>I (Satu)</option>
                                        <option value="2" {{ $mapels->semester == '2'? 'selected': ''}}>II (Dua)</option>
                                    </select>
                                </div>
